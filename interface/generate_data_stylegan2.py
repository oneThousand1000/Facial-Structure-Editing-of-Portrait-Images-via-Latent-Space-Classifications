...
def parse_args():
    ...
    parser.add_argument('-o', '--output_dir', type=str, default='F:/DoubleChin/datasets/ffhq_gen_data/stylegan_ffhq_2_new_sample',
...
def main():
    ...
    if args.double_chin_only:
        print('only generate double chin!')
    else:
        print('generate all face!')
    ...
    print('%d double chin images'%count)
