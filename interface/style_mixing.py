...
from interface.models.stylegan2_generator import StyleGAN2Generator
...
def parse_args():
    ...
    parser.add_argument('-o', '--output_dir', type=str, default='F:/DoubleChin/styleGAN_related/interfacegan/data/stylegan_ffhq_2_mixed',
                        help='Directory to save the output results. (required)')
    parser.add_argument('-i', '--latent_codes_path', type=str, default='F:/DoubleChin/styleGAN_related/interfacegan/data/stylegan_ffhq_2/z.npy',
