...
#
#     if not os.path.exists(f'F:/DoubleChin/datasets/CelebAMask-HQ/neck_mask/{name}.png'):
#         mask = get_simple_neck_mask(img=img)
#         print(img)
#         cv2.imwrite(f'F:/DoubleChin/datasets/CelebAMask-HQ/neck_mask/{name}.png',mask)
